...
static_assert(
    std::is_same_v<sort_unique_reverse_t<boost::mp11::mp_list<std::integral_constant<std::size_t, 1>, std::integral_constant<std::size_t, 2>, std::integral_constant<std::size_t, 1>>>,
    boost::mp11::mp_list<std::integral_constant<std::size_t, 2>, std::integral_constant<std::size_t, 1>>>);

static_assert(198 == boost::mp11::mp_size<sort_unique_reverse_t<boost::mp11::mp_list<
